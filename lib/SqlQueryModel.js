...
var SqlQueryModel = /** @class */ (function () {
    ...
    Object.defineProperty(SqlQueryModel.prototype, "asRelation", {
        get: function () {
            this.$type = enums_1.SqlRefinerType.Relation;
            return this;
        },
        enumerable: true,
        configurable: true
    ...
    SqlQueryModel.prototype.with = function () {
        ...
        this.$with = args.map(function (e) { return e.build(); });
        return this;
    };
    ...
    SqlQueryModel.prototype.bool = function (key, value, flags) {
        return this.refiner(key, value, enums_1.SqlOperator.EQ, enums_1.SqlRefinerType.Boolean);
    };
