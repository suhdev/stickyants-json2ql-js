...
export declare class SqlQueryModel {
    ...
    addSort(sort: ISqlRefiner): this;
    addSorters(sorters: ISqlRefiner[]): this;
    ...
    text(key: string, value: string, operator: SqlOperator, flags?: SqlQueryFlags): this;
    number(key: string, value: number, operator: SqlOperator, flags?: SqlQueryFlags): this;
    bool(key: string, value: boolean, flags?: SqlQueryFlags): this;
